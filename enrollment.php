            ...
            <div class="container-fluid">
                <form action="" id="enrollment-form">
                    ...
                    <fieldset>
                        ...
                        <!-- Start Date and Prefered Time Selection -->
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
...
<script>
    ...
    // Function to Calculate total cost for selected services
    function calc() {
        var total = 0;
    ...
    $(function() {
        ...
        // On Package Change, Show Package Details
