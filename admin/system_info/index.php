...
<style>
/* Style for circular system logo preview */
img#cimg {
    height: 15vh;
    width: 15vh;
...
<!-- Main container for the system settings form -->
<div class="col-lg-12">
    <div class="card card-outline card-primary">
        <div class="card-header">
            <!-- Title of the settings form -->
        ...
        <div class="card-body">
            <form action="" id="system-frm">
                ...
                <!-- Input: Welcome Content using Summernote editor -->
                <div class="form-group">
                ...
                <!-- Input: About Us content using Summernote editor -->
                <div class="form-group">
                ...
                <!-- Driving School Information section -->
                <fieldset>
...
<script>
// Shows preview of uploaded logo image
...
// Shows preview of uploaded cover image
...
// (Optional) Shows preview of another image 
...
// Initialize Summernote (WYSIWYG- What you see is what you get)
$(document).ready(function() {

    // Apply Summernote editor to textareas with class 'summernote'
