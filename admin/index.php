<!-- Include configuration file for database and system settings -->
...
<body class="sidebar-mini layout-fixed control-sidebar-slide-open layout-navbar-fixed sidebar-mini-md sidebar-mini-xs"
    ...
    <div class="wrapper">
        ...
        <!-- Show toast notification if there's a 'success' flash message -->
        ...
        <div class="content-wrapper pt-3" style="min-height: 567.854px;">
          ...
          if (!file_exists($page . ".php") && !is_dir($page)) {
            // If not found, load the 404 error page
            include '404.html';
          } else {
            // If it's a folder, load its index page
            if (is_dir($page))
              include $page . '/index.php';
            else
              // Otherwise, include the requested PHP page
              include $page . '.php';
          }
          ?>
                </div>
            ...
            <!-- Image Viewer Modal (displays an image in a popup) -->
